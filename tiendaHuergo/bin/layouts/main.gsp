...
<html lang="en" class="no-js">
  <head>
    ...
    <title><g:layoutTitle default="Tienda Huergo"/></title>
  ...
  <body>
    <nav
      ...
      "
    >
      <a class="navbar-brand" href="https://huergo.com.ar/Login.aspx"
        >Huergo - SIPA</a
      >
      <button
      ...
      <div style="padding-right: 5px">
        <g:link class="ml-auto" controller="carrito" action="index">
          <iconify-icon icon="bi:cart-fill" width="50px"></iconify-icon
        ></g:link>
        <g:link class="ml-auto" controller="logout" action="index">
          <iconify-icon icon="ion:log-out-sharp" width="50px"></iconify-icon
        ></g:link>
      </div>
    </nav>
